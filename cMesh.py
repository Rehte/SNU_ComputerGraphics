...
class cMesh:
    ...
    def toEdgeFriend(self):
        self.edgeFriend = edgeFriendMesh(self.vertices)
        ...
        # print(self.edgeFriend.i)
        # print(self.edgeFriend.g)
        # print(self.edgeFriend.l)

    def getIndices(self):
        indices = []
        for i in range(len(self.edgeFriend.i)//4):
            indices += [self.edgeFriend.i[i*4], self.edgeFriend.i[i*4+1], self.edgeFriend.i[i*4+2]]
            indices += [self.edgeFriend.i[i*4+2], self.edgeFriend.i[i*4+3], self.edgeFriend.i[i*4]]
